...
export function getProjectArrayFromFirebase(
  ...
  return projectsRequest.map((project: any) => ({
    ...
    primaryImageURL: project.images.find((image: any) => image.isPrimaryImage)
      .imageURL,
...
const Projects = () => {
  ...
  return (
    <div className="md:px-28 px-4 projectsContainer">
      <motion.h1 className="text-center text-5xl md:text-8xl uppercase text-white font-bold primary">
        Projects
      </motion.h1>
      <section
        id="section2"
      ...
      >
        <div className="overflow-hidden">
          <motion.img
            ...
            className="project__image w-full h-60 object-cover"
            alt={project.title}
